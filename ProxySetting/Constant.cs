namespace StrongProxy
{
    public class Constant
    {
        ...
        public const string DISPLAY_ERROR_PROXYSERVER = "Proxyサーバーの値エラー。";

        public const string DISPLAY_ERROR_IP = "0～255範囲内の値を設定してください。";
        ...
        public const string DISPLAY_ERROR_FILE = "正しいファイルを選択してください。";
